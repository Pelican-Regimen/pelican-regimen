...
private fun HighlightedSnacks(
    ...
    val gradient = when ((index / 2) % 2) {
        0 -> PelicanRegimenTheme.colors.gradient6_1
        else -> PelicanRegimenTheme.colors.gradient6_2
    }
    // The Cards show a gradient which spans 3 cards and scrolls with parallax.
...
fun SnackCardPreview() {
    PelicanRegimenTheme {
        ...
        HighlightSnackItem(
            ...
            onSnackClick = { },
            index = 0,
            gradient = PelicanRegimenTheme.colors.gradient6_1,
